...
public final class HotkeyService: ObservableObject {
    ...
    public init() {
        self.hotkeyId = EventHotKeyID(signature: OSType("SWSC".fourCharCode), id: 1)
    ...
    public func registerHotkey(modifiers: UInt32, keyCode: UInt32) {
    ...
    public func registerHotkey(from hotkeyString: String) {
